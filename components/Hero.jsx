        ...
        <div className='flex flex-col text-center items-center justify-center gap-5'>
          ...
          <div className='flex items-center justify-center gap-4'>
            <Link legacyBehavior href='https://www.dropbox.com/scl/fi/9hfvt4a5lp1wyolzqz5gd/ADITYA.pdf?rlkey=vlkm8dx2uqgdhfb01crrxnyh2&dl=0' className='mt-10'>
              <a href='https://www.dropbox.com/scl/fi/9hfvt4a5lp1wyolzqz5gd/ADITYA.pdf?rlkey=vlkm8dx2uqgdhfb01crrxnyh2&dl=0' className='text-white border rounded-2xl px-3 py-2 flex gap-2 items-center justify-center '>Download CV <AiOutlineCloudDownload className='down-arrow' /></a>
            </Link>
